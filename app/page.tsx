    ...
    <main>
      ...
      <div className="main">
        <div className="mail_input">
          <p id="email-address">{email || 'Generating...'}</p>
          <button id="copy-btn" onClick={handleCopy} className="copy_btn" data-tippy-content="Copy" data-tippy-placement="right">
        ...
        <div className="toolbar">
          <button id="new-btn" onClick={createNewEmail} className="new" data-tippy-content="Generate New Email" data-tippy-placement="bottom">
          ...
          <button id="delete-btn" onClick={handleDelete} className="delete" data-tippy-content="Delete Current Session" data-tippy-placement="bottom">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="more" data-tippy-content="More Options" data-tippy-placement="bottom">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {isCopied && <div className="toast">Email copied</div>}
    </main>
  );
}
